    ...
    <div class="container mt-3">
        ...
        <form enctype= "multipart/form-data" method="POST" action="proses.php?aksi=update">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nim" name="nim" value="<?php echo $dataUser ["nim"] ?>"require >

                <label for="nama" class="form-label">Nama</label>
                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $dataUser ["nama"] ?>"require >

                <label for="jeniskelamin" class="form-label">Jenis Kelamin</label>
                <select id="jeniskelamin" name="jeniskelamin" class="form-select mb-4"  >
                    <option value="" disabled <?php if(!$dataUser["jeniskelamin"]) echo 'selected'; ?>require>Pilih jenis kelamin</option>
                ...
                <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $dataUser ["alamat"] ?>"require >

                <label for="nohp" class="form-label">No HP</label>
                <input type="text" class="form-control" id="nohp" name="nohp" value="<?php echo $dataUser ["nohp"] ?>"require >
